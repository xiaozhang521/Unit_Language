...
class HubertEncoder(FairseqEncoder):
    def __init__(self, cfg: HubertAsrConfig, task):
        ...
        if cfg.w2v_args is None:
            #cfg.w2v_path = '/workspace/fairseq-IMTL/examples/hubert/mhubert_base_vp_en_es_fr/mhubert_base_vp_en_es_fr_it3.pt'
            cfg.w2v_path = '/workspace/pretrain/hubert_base_ls960.pt'
            # cfg.w2v_path = '/workspace//fairseq-IMTL/examples/hubert/speech_normalizer_es_10h/checkpoint_best.pt'
