...
class InferenceProcessor:
    ...
    def process_sentence(
        ...
        if self.cfg.decoding.results_path is not None:
            ...
            print(f"N-{sid}\t{hyp_pieces}", file=self.hypo_units_file)
            print(f"N-{sid}\t{hyp_words}", file=self.hypo_words_file)
            print(f"N-{sid}\t{tgt_pieces}", file=self.ref_units_file)
            print(f"N-{sid}\t{tgt_words}", file=self.ref_words_file)
